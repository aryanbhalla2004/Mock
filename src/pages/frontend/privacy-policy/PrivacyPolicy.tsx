    ...
    <>
      ...
      <div className='privacy-container'>
        <div className='content-sizing privacy-wrapper'>
          ...
          <li>
          <p><strong>Application</strong> refers to Zoobo, the software program provided by the Company.</p>
          </li>
          <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Zoobo, 36 valley brook rd., Winnipeg MB, Canada, r3y0w8.</p>
          </li>
          <li>
          ...
          <li>
          <p><strong>Website</strong> refers to Zoobo, accessible from <a href="crew.zoobo.ca" rel="external nofollow noopener" target="_blank">crew.zoobo.ca</a></p>
          </li>
          <li>
          ...
          <ul>
          <li>
          <p>By email: <Link to="">support@zoobo.ca</Link></p>
          </li>
          <li>
          <p>By visiting this page on our website: <a href="crew.zoobo.ca" rel="external nofollow noopener" target="_blank">crew.zoobo.ca</a></p>
          </li>
          </ul>
        </div>
      </div>
