    ...
    <div className='auth-12-register-step-3 animate-entry-signup'>
      <div className='auth-12-register-header-text'>
        ...
        <ul className='profile-select-tab'>
          ...
          <li className={props.formData.WorkingStatus === "WORKPERMIT" ? "active-selection-proof" : ""} onClick={e => setFileType("WORKPERMIT")}><i className="bi bi-person-vcard"></i> In Canada on work permit?</li>
