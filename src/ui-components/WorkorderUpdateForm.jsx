...
export default function WorkorderUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCompletionImage(cleanValues.completionImage ?? []);
    setCurrentCompletionImageValue("");
    setUsercompletion(cleanValues.usercompletion);
    setWorkercompletion(cleanValues.workercompletion);
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Workorder, idProp)
        : workorderModelProp;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Workorder.copyOf(workorderRecord, (updated) => {
